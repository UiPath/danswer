...
export function _WelcomeModal({ user }: { user: User | null }) {
  ...
  switch (selectedFlow) {
      ...
      body = (
        <div className="max-h-[85vh] overflow-y-auto px-4 pb-4">
          ...
          <div className="mt-3">
            ...
            <div>
              <Text>
                Connectors are the way that Darwin gets data from your
                organization&apos;s various data sources. Once setup, we&apos;ll
                automatically sync data from your apps and docs into Darwin, so
    ...
    case "chat":
      ...
      break;
    default:
      title = "🎉 Welcome to Darwin";
      body = (
        <>
          <div>
            <Text>How are you planning on using Darwin?</Text>
          </div>
          <Divider />
          <UsageTypeSection
